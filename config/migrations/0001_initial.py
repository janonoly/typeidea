# Generated by Django 3.0.3 on 2020-03-01 08:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_type', models.PositiveSmallIntegerField(choices=[(1, '最新文章'), (2, '最热文章'), (3, '最近评论'), (4, '最近评论')], default=1, verbose_name='展示类型')),
                ('content', models.CharField(blank=True, help_text='如果设置的不是HTML类型，可为空', max_length=500, verbose_name='内容')),
                ('status', models.PositiveSmallIntegerField(choices=[(1, '展示'), (0, '隐藏')], default=1, verbose_name='状态')),
